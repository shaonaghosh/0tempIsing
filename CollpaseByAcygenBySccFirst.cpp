...
bool isInUndirectedToContract2( int index, list<vector<int>> nodestocontractlist, vector<int>& undirected)
{
...
void collapseUndirectededges2(int sccindex, vector<int> undirectededges, int supernodeidx, 
...
void collapseDirectedEdges2(vector<int> sccin, int supernodeidx, vector<int>& nodescontracted, mapstype& collapmap, 
...
void findkArbFlowPaths2(list<vector<int>>& flowpathslist, int& cntmaxflowpath, adjmattype& residualcpy, 
...
void findAllUndirEdgesToCollapse2(list<vector<int>>& nodestocontractlist, vector<int>& nodestocontract, adjmattype residualcpy, 
...
void contractGraphSCCBySccFirst(vector<int> parentorig, int maxflow, adjmattype &residual, int source, int target, 
	adjmattype AdjMat, const int n, adjmattype &newAdjMat, list<vector<int>>& flowpathslist, mapstype& collapmap, vector<int> labnodesvect)
{
	...
	findkArbFlowPaths2(flowpathslist, cntmaxflowpath, residualcpy, 
